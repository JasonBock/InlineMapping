...
internal sealed class MappingIncrementalInformation
{
   public MappingIncrementalInformation(SyntaxNode currentNode, INamedTypeSymbol source, INamedTypeSymbol destination,
