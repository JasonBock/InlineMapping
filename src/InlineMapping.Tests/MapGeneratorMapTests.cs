...
{ 
	public int Id { get; set; }
		...
		[Test]
		public static void GenerateWithMatchingPropertyTypeKindAsExactAndTypesAreExact()
		{
			var (diagnostics, output) = MapGeneratorMapTests.GetGeneratedOutput(
@"using InlineMapping;
...
{ 
	public string Id { get; set; }
		...
		[Test]
		public static void GenerateWithMatchingPropertyTypeKindAsImplicitAndTypesAreExact()
		{
			var (diagnostics, output) = MapGeneratorMapTests.GetGeneratedOutput(
@"using InlineMapping;
...
{ 
	public string Id { get; set; }
		...
		[Test]
		public static void GenerateWithMatchingPropertyTypeKindAsExactAndTypesAreImplicit()
		{
			var (diagnostics, output) = MapGeneratorMapTests.GetGeneratedOutput(
@"using InlineMapping;
...
{ 
	public B Id { get; set; }
		...
		[Test]
		public static void GenerateWithMatchingPropertyTypeKindAsImplicitAndTypesAreImplicit()
		{
			var (diagnostics, output) = MapGeneratorMapTests.GetGeneratedOutput(
@"using InlineMapping;
